      ...
      return (
        <div className="content-box dash-post-box" key={post.post_id}>
          ...
          <div  className='post-title'>
            <Link style={{textDecoration: 'none'}}  to={`/post/${post.post_id}`}>
              {" "}
      ...
      <div className="dash">
        <div className="dash-filter">
          <div className="dash-search-box">
            ...
            />
            <FontAwesomeIcon icon={faSearch} onClick={this.grabPosts} className="dark-button"/>
              
          
            <FontAwesomeIcon icon={faSync} onClick={this.reset} className="dark-button"/>
